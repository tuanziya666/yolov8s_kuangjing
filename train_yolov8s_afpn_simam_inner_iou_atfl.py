...
MODEL_CFG = "ultralytics/cfg/models/v8/yolov8s_afpn_simam.yaml"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train YOLOv8s AFPN+SimAM with ATFL classification loss and Inner-IoU box regression loss."
    )
    ...
    parser.add_argument("--name", default="yolov8s_afpn_simam_inner_iou_atfl", help="Experiment name.")
