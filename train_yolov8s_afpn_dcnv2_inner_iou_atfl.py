...
MODEL_CFG = "ultralytics/cfg/models/v8/yolov8s_afpn_backbone_dcnv2_p45.yaml"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train YOLOv8s AFPN with backbone C2f-DCNv2, ATFL classification, and Inner-IoU regression."
    )
    ...
    parser.add_argument("--name", default="yolov8s_afpn_dcnv2_inneriou_atfl", help="Experiment name.")
...
def main():
    ...
    print("note = AFPN neck kept fixed; backbone P4/P5 C2f blocks are replaced with C2fDCNv2")
