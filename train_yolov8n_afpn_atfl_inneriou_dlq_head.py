...
MODEL_CFG = "ultralytics/cfg/models/v8/yolov8n_afpn.yaml"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Train YOLOv8n AFPN with ATFL + Inner-IoU + Drill-pipe Localization Quality Calibration Head (DLQ-Head)."
        )
    )
    ...
    parser.add_argument(
        "--name",
        default="yolov8n_afpn_atfl_inneriou_dlq_head",
...
def main():
    ...
    print("note = YOLOv8n AFPN + ATFL + Inner-IoU + DLQ weighted")
