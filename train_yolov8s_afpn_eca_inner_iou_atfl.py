...
MODEL_CFG = "ultralytics/cfg/models/v8/yolov8s_afpn_eca.yaml"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train YOLOv8s AFPN+ECA with ATFL classification loss and Inner-IoU box regression loss."
    )
    ...
    parser.add_argument("--name", default="yolov8s_afpn_eca_inner_iou_atfl", help="Experiment name.")
